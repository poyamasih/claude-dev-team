...
Write-Host "     Set-Content `"$dest/gemini_design.key`" 'YOUR_GEMINI_KEY' -NoNewline   # gitignored, local only"
Write-Host "     Set-Content `"$dest/stitch.key`" 'YOUR_STITCH_KEY' -NoNewline          # gitignored, local only"
Write-Host "     Full key guide: docs/API-KEYS.md"
