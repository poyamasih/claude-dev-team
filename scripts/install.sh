...
echo "     printf %s YOUR_GEMINI_KEY > \"$DEST/gemini_design.key\"   # gitignored, local only"
echo "     printf %s YOUR_STITCH_KEY > \"$DEST/stitch.key\"          # gitignored, local only"
echo "     Full key guide: docs/API-KEYS.md"
